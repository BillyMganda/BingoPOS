...
{
    public partial class Bingo_Team : Form
    {
        public Bingo_Team()
        {
            InitializeComponent();
        ...
        //LOAD
        private void Bingo_Team_Load(object sender, EventArgs e)
        {
            textBox1.Text=Choose_Bingo_Session.date;
            textBox2.Text=Choose_Bingo_Session.time;
            textBox3.Text=Choose_Bingo_Session.LogedUser;
